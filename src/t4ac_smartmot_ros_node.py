...
class SmartMOT():
    def __init__(self):
        ...
        self.sub_location_ego = rospy.Subscriber(monitored_lanes_topic, MonitorizedLanes, self.monitored_lanes_callback)
    ...
    def detections_callback(self, detections_rosmsg):
        ...
        monitored_lanes_rosmsg = self.monitored_lanes
        ...
        for tracker in trackers:
            ...
            tracker_marker = ros_functions.tracker_to_marker(tracker,color,stamp)
